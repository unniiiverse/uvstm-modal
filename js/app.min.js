function uvstm_modal(){const container=document.querySelector('.uvstm-modal-container');const triggers=document.querySelectorAll('.uvstm-modal-trigger_button');const modals=document.querySelectorAll('.uvstm-modal-container_modal');if(container&&triggers&&modals){triggers.forEach((el,i)=>{if(!el.hasAttribute('data-uvstm-modal-customID')){el.setAttribute('id',`uvstm-modal-trigger_buttonID--${i}`);el.setAttribute('data-uvstm-modal-trigger_openID',`uvstm-modal-container_modal--${i}`)}else{let params=el.getAttribute('data-uvstm-modal-customID').split(' ');el.setAttribute('id',params[0]);el.setAttribute('data-uvstm-modal-trigger_openID',params[1])}})
